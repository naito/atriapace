...
sim_length = BCL/1000 * 4; % sim_length = BCL/1000;
stim = stim_creator_BCL(BCL, 10e-3, sim_length); % stim = stim_creator_BCL(BCL, 1e-3, sim_length);
...
if BCL < 1000
    ...
    main_human_atrial(stim, ['y0_ss_BCL_' num2str(BCL) '.dat'], ['1AP_BCL_' num2str(BCL) '.dat'], sim_length, BCL, 1, modelswitch);
